...
/*   Updated: 2019/12/05 20:42:55 by tmaluh           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int __attribute__((format(printf,1,0),__nonnull__(1,2)))
...
int __attribute__((format(printf,2,0),__nonnull__(1,2,3)))
ft_vsprintf(char *str, const char *restrict format, va_list *restrict ap);

int __attribute__((format(printf,3,4),__nonnull__(1,3)))
ft_snprintf(char *dst, size_t len, const char *restrict format, ...);
int __attribute__((format(printf,3,0),__nonnull__(1,3,4)))
